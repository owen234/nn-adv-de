...
// Thu Aug  3 10:55:06 2023 by ROOT version 6.24/07
// from TChain nnout/
//////////////////////////////////////////////////////////

#ifndef fill_hists_for_unfolding1_h
#define fill_hists_for_unfolding1_h
...
class fill_hists_for_unfolding1 {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         simple_classifier_output_gen;
   Float_t         simple_classifier_output_obs;
   Float_t         classifier_output_gen;
   Float_t         classifier_output_obs;
   Float_t         classifier_output_gen_lam0;
   Float_t         classifier_output_obs_lam0;
   ...
   TBranch        *b_simple_classifier_output_gen;   //!
   TBranch        *b_simple_classifier_output_obs;   //!
   TBranch        *b_classifier_output_gen;   //!
   TBranch        *b_classifier_output_obs;   //!
   TBranch        *b_classifier_output_gen_lam0;   //!
   TBranch        *b_classifier_output_obs_lam0;   //!

   fill_hists_for_unfolding1(const char* infile = "output_django.root" );
   virtual ~fill_hists_for_unfolding1();
...
#ifdef fill_hists_for_unfolding1_cxx
fill_hists_for_unfolding1::fill_hists_for_unfolding1(const char* infile ) : fChain(0) 
{
...
fill_hists_for_unfolding1::~fill_hists_for_unfolding1()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t fill_hists_for_unfolding1::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t fill_hists_for_unfolding1::LoadTree(Long64_t entry)
{
...
void fill_hists_for_unfolding1::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("simple_classifier_output_gen", &simple_classifier_output_gen, &b_simple_classifier_output_gen);
   fChain->SetBranchAddress("simple_classifier_output_obs", &simple_classifier_output_obs, &b_simple_classifier_output_obs);
   fChain->SetBranchAddress("classifier_output_gen", &classifier_output_gen, &b_classifier_output_gen);
   fChain->SetBranchAddress("classifier_output_obs", &classifier_output_obs, &b_classifier_output_obs);
   fChain->SetBranchAddress("classifier_output_gen_lam0", &classifier_output_gen_lam0, &b_classifier_output_gen_lam0);
   fChain->SetBranchAddress("classifier_output_obs_lam0", &classifier_output_obs_lam0, &b_classifier_output_obs_lam0);
   Notify();
}

Bool_t fill_hists_for_unfolding1::Notify()
{
...
void fill_hists_for_unfolding1::Show(Long64_t entry)
{
...
Int_t fill_hists_for_unfolding1::Cut(Long64_t entry)
{
...
#endif // #ifdef fill_hists_for_unfolding1_cxx
